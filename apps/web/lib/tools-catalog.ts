...
export const TOOL_CATEGORIES: ToolCategory[] = [
  ...
  },
  {
    label: 'chain',
    tools: [
      { name: 'chain.balance', desc: 'read EOA balance (MNT)' },
      { name: 'chain.send', desc: 'send native MNT (gated)' },
      { name: 'chain.wrap', desc: 'wrap MNT to WMNT (gated)' },
      { name: 'chain.unwrap', desc: 'unwrap WMNT to MNT (gated)' },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'account.balance', desc: 'native MNT position' },
    ],
  },
  {
    label: 'memory',
