...
Source: [`apps/web/app/api/auth`](https://github.com/rstfulzz/nebula/tree/main/apps/web/app/api/auth).
...
key = HKDF-SHA256(sig, info='nebula-keystore-aead-v1')
...
Source: [`apps/web/components/console/UnlockKeystore.tsx`](https://github.com/rstfulzz/nebula/blob/main/apps/web/components/console/UnlockKeystore.tsx).
