...
Foreign iNFTs are auditable in raw mode. Pass a positional ref: `nebula inspect 0g-mainnet:0xCONTRACT:tokenId` and you see the slot layout and sizes without needing the decryption key.
