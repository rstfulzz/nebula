/**
 * `<label>.nebula.0g` subname validation.
 *
 * Rules locked Apr 23 2026 (project-nebula.md section 33 + matches the
 * NebulaSubnameRegistrar contract's on-chain check):
 *   - 3-32 characters total
 *   - lowercase a-z, 0-9, hyphens
 *   - no leading or trailing hyphen
 *
 * Used by:
 *   - `nebula init` wizard's subname prompt (cli/commands/init.ts)
