...
function printHelp(): void {
  console.log(
    [
      ...
      '  nebula connect             link a CSPR.click web wallet (no local PEM needed)',
      '                            with a wallet connected and no PEM set, writes are signed by',
      '                            the connected wallet in your browser',
