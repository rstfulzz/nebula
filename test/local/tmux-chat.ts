/**
 * tmux driver for `nebula` (chat). Catches the regression class where the TUI
 ...
 * catch that is to drive a real tmux pane: spawn nebula, send a real message,
